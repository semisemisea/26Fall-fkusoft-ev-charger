/**
 * @file charge_ring_widget.cpp
 * @brief 绘制循环旋转圆环，并随可见性管理动画生命周期。
 */
#include "charge_ring_widget.h"
...
/**
 * @details 显示时启动无限循环的角度动画；时长经 demo::ms 适配演示模式
 */
...
/**
 * @details 绘制灰色底盘环与 110 度进度弧；drawArc 角度单位为 1/16 度
 */
