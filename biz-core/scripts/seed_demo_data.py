...
def populate(db, now, days, seed):
    ...
    stations = []
    # 大连市中心周边的模拟点位，靠近 user-app 默认查询位置 (38.914, 121.614)。
    locations = [
        ("大连人民广场", 38.9130, 121.6140), ("劳动公园", 38.9100, 121.6350),
        ("青泥洼桥", 38.9180, 121.6350), ("中山广场", 38.9210, 121.6440),
        ("奥林匹克广场", 38.9050, 121.6070), ("西安路", 38.9180, 121.5880),
        ("星海广场", 38.8810, 121.5840), ("东港商务区", 38.9280, 121.6630),
    ]
    chargers = []
